...
void SceneBase::Init()
{
	...
	meshList[GEO_BASE] = MeshBuilder::GenerateQuad("Base1", Color(1, 0, 0),1);
	meshList[GEO_BASE2] = MeshBuilder::GenerateQuad("Base1", Color(0, 1, 0), 1);
	...
	meshList[GEO_HEALER] = MeshBuilder::GenerateQuad("healer", Color(1, 1, 1));
	...
	meshList[GEO_MONSTER] = MeshBuilder::GenerateQuad("monster", Color(1, 1, 1));
	...
	meshList[GEO_LINE] = MeshBuilder::GenerateLine("Line", Color(1.f, 0.f, 0.f), 1.f);
	meshList[GEO_LINE2] = MeshBuilder::GenerateLine("Line", Color(0.f, 1.f, 0.f), 1.f);
	meshList[GEO_TEXT]->material.kAmbient.Set(1, 0, 0);
	meshList[GEO_PROJECTILE] = MeshBuilder::GenerateQuad("Projectile", Color(1, 1, 1));
	meshList[GEO_PROJECTILE]->textureID = LoadTGA("Image//Projectile.tga");
	...
	meshList[GEO_QUEEN] = MeshBuilder::GenerateQuad("Chessboard", Color(1, 1, 1));
	...
	meshList[GEO_BLUEQUAD] = MeshBuilder::GenerateQuad("BlueQuad", Color(0, 0, 1));
	meshList[GEO_GREYQUAD] = MeshBuilder::GenerateQuad("Whitequad", Color(.5f, .5f, .5f));
	meshList[GEO_BLACKQUAD] = MeshBuilder::GenerateQuad("Whitequad", Color(0, 0, 0));
	...
	meshList[GEO_TANK] = MeshBuilder::GenerateQuad("Tank", Color(1, 1, 1));
	meshList[GEO_TANK]->textureID = LoadTGA("Image//Tank.tga");
	meshList[GEO_TANK2] = MeshBuilder::GenerateQuad("Tank2", Color(1, 1, 1));
	meshList[GEO_TANK2]->textureID = LoadTGA("Image//Tank2.tga");
	...
	meshList[GEO_SOLDIER2] = MeshBuilder::GenerateQuad("Soldier2", Color(1, 1, 1));
	meshList[GEO_SOLDIER2]->textureID = LoadTGA("Image//Soldier2.tga");
	meshList[GEO_ARCHER] = MeshBuilder::GenerateQuad("Archer", Color(1, 1, 1));
